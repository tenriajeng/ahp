              ...
              <table class="table table-striped">
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td>
                        <a type="button" class="btn btn-default btn-sm" class="hapus" href="edit.php?id=<?php echo $data['id']; ?>">EDIT</a>
                    </td>
                    <td>
                        <a type="button" class="btn btn-default btn-sm" class="hapus" href="hapus.php?id=<?php echo $data['id']; ?>">DELETE</a>
                    </td>
                  </tr>
                  <?php } ?>
                </tr>

        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <body>
              ...
              <?php 
                  include "koneksi.php";
                  $name2 = mysqli_query($connection,"SELECT * FROM jurusan");
             ...
             <form action="input-aksi.php" method="post" enctype="multipart/form-data">
               <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select name="jurusan" class="form-control" name="id">
                  <option>Pilih Kriteria</option>
                  <?php
                  if (mysqli_num_rows($name2) > 0) { ?>
                    <?php while ($row = mysqli_fetch_array($name2)) { ?>
                      <option><?php echo $row['jur']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <select class="form-control" name="tujuan">
                    <option>KP (Kerja Praktek)</option>
                    <option>KKLP (Kuliah Kerja Lapangan Profesi)</option>
                    <option>PKL (Praktek Kerja Lapangan)</option>
                  </select>
                </div>
                <div class="form-group">
